...
Bu layihə **PostgreSQL** istifadə edərək 17,000-dən çox futbolçunun datasını analiz edir. Layihə çərçivəsində böyük həcmli CSV datası təmizlənmiş və scouting (skautinq) hesabatları hazırlanmışdır.
